...
let data = pokemonCharacter.pokemon


let infoPokemon = function(names){
    let isFound = false
for(currentPokemon in data){
    //console.log(data[x])
    if(data[currentPokemon].name == names)
    {
        alert("success")
        break
    }
    ...
    let names = prompt("enter the pokemon's name for complete detail")
    infoPokemon(names);
